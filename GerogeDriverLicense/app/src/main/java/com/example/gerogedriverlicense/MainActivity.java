...
public class MainActivity extends AppCompatActivity {
    ...
    public void submitall(View view) {
        ...
        if (strlastname.trim().equals("") && strfirstname.trim().equals("") && strmiddlename.trim().equals("")
            ...
            Intent intent = new Intent(this, Nonedata.class);
            ...
            senddata.putExtra("lnameko", lname.getText().toString());  // pass your values and retrieve them in the other Activity using AnyKeyName
