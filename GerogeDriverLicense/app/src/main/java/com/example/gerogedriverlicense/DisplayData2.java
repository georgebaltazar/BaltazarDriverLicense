package com.example.gerogedriverlicense;
...
public class DisplayData2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nonedata);
